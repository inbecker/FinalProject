...
<html>
       ...
       <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" integrity="sha384-WskhaSGFgHYWDcbwN70/dfYBj47jz9qbsMId/iRN3ewGhXQFZCSftd1LZCfmhktB" crossorigin="anonymous">
        ...
        <script>
            function reload(form) {
                ...
                self.location = 'about.php?styleName=' + val;
            }
        </script>
    ...
    <body>
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item" href="british.php">English Ale</a>
        ...
        <br>
    <main>
        <center>   <img src="images/beerBanner2.png"><br><br><br></center>
        <p align="center" class="main">This is a website created by Misha and Ini</p>
        
        <p align="center" class="main">We have all styles of American Beers at Beer Hall</p>
        
        <p align="center" class="main">Use the list bellow to select the style of beer you like! </p>
        <br>
        <br>
        <br>
        <br>
